...
//A este fomulario creeria seria conveniente agregarle una fecha
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const formulario = document.getElementById("formulario");
        ...
        const campos = [
            ...
            { id: 'ProductoDevuelto', regex: /^[a-zA-Záéíóú\s]{3,20}\D[a-zA-Z]{3,20}/ },
            { id: 'MotivoDevolucion', regex:/r'^.{20,100}$'/ },
